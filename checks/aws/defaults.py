...
EC2_SCHEDULE_AWARE_MIN_ACTIVE_HOURLY_DATAPOINTS: Final[int] = 8
EC2_SCHEDULE_AWARE_BUSINESS_HOUR_SHARE_THRESHOLD: Final[float] = 0.75
EC2_SCHEDULE_AWARE_OFF_HOUR_SHARE_THRESHOLD: Final[float] = 0.20
...
DYNAMODB_MOVE_TO_ON_DEMAND_UTIL_THRESHOLD_PCT: Final[float] = 5.0
DYNAMODB_UNUSED_GSI_MAX_P95_CAPACITY_UNITS: Final[float] = 1.0
DYNAMODB_STANDARD_IA_MAX_UTIL_THRESHOLD_PCT: Final[float] = 10.0
DYNAMODB_STANDARD_IA_MIN_TABLE_SIZE_GIB: Final[float] = 100.0
DYNAMODB_MAX_FINDINGS_PER_TYPE: Final[int] = 50_000
KINESIS_LOOKBACK_DAYS: Final[int] = 14
KINESIS_MIN_DAILY_DATAPOINTS: Final[int] = 7
KINESIS_PROVISIONED_UNDERUTILIZED_UTIL_THRESHOLD_PCT: Final[float] = 10.0
KINESIS_RETENTION_REVIEW_MIN_HOURS: Final[int] = 168
KINESIS_RETENTION_LOW_TRAFFIC_P95_DAILY_GIB_THRESHOLD: Final[float] = 5.0
KINESIS_UNUSED_EFO_MAX_P95_OUTGOING_RECORDS: Final[float] = 100.0
KINESIS_ORPHANED_MAX_P95_DAILY_GIB: Final[float] = 0.25
KINESIS_ORPHANED_MAX_P95_INCOMING_RECORDS: Final[float] = 100.0
KINESIS_ORPHANED_MAX_P95_OUTGOING_RECORDS: Final[float] = 100.0
KINESIS_MAX_FINDINGS_PER_TYPE: Final[int] = 50_000
KINESIS_FALLBACK_SHARD_HOURLY_USD: Final[float] = 0.015
KINESIS_FALLBACK_EFO_CONSUMER_SHARD_HOURLY_USD: Final[float] = 0.015
...
RDS_REPLICA_SCHEDULE_WINDOW_DAYS: Final[int] = 7
RDS_REPLICA_SCHEDULE_PERIOD_SECONDS: Final[int] = 3600
RDS_REPLICA_SCHEDULE_MIN_ACTIVE_HOURS: Final[int] = 8
RDS_REPLICA_SCHEDULE_BUSINESS_HOUR_SHARE_THRESHOLD: Final[float] = 0.75
RDS_REPLICA_SCHEDULE_OFF_HOUR_SHARE_THRESHOLD: Final[float] = 0.20
RDS_REPLICA_SCHEDULE_WEEKEND_SHARE_THRESHOLD: Final[float] = 0.15
...
EFS_LOW_ACCESS_P95_DAILY_IO_BYTES_THRESHOLD: Final[float] = 100 * 1024.0**2
EFS_LOW_ACCESS_MAX_CLIENT_CONNECTIONS_THRESHOLD: Final[float] = 5.0
