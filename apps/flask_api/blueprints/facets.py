"""Facet endpoints for finding filters."""
...
from apps.flask_api.utils import _err, _ok, _require_scope_from_query
...
def api_facets() -> Any:
    """Return distinct values and counts for common finding filters."""
    try:
